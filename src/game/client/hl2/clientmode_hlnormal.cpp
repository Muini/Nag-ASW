...
ConVar default_fov( "default_fov", "85", FCVAR_CHEAT );
ConVar fov_desired( "fov_desired", "85", FCVAR_ARCHIVE | FCVAR_USERINFO, "Sets the base field-of-view.", true, 75.0, true, 90.0 );
